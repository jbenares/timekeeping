...
$select = mysqli_query($con_tk, "SELECT * FROM timekeeping WHERE personal_id = '$id' AND DATE_FORMAT(recorded_time, '%Y-%m-%d') = '$date'");
...
<div style="padding: 30px">
    <div style="background: #fff">
        <center>
            <b><h3>ONLINE REPORT</h3></b>
        </center>
        <table width="100%" class="table-bordered table">
            <tr>
                <td colspan="2">
                    <h4 style="margin:0px"><b><?php echo getname($con_tk, $id) . " / " . $date; ?></b></h4>
