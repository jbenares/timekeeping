    ...
    <body>
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    <center>
                        <a class="brand" style="float: none;padding-bottom: 10px" href="#">CENTRAL NEGROS POWER RELIABILITY INC.<br> 
                            <p style="font-size: 14px;padding: 0px;font-weight: 300; letter-spacing: 3px; font-family: Arial" >TIME KEEPING</p>
                        </a>
                    </center>
                </div>
            </div>
